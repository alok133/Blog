...
@foreach($data as $datas)   
	    <h1 class="blog-name pt-lg-4 mb-0"><a href="index.html">{{$datas->username}}'s Blog</a></h1>
	    ...
	    <nav class="navbar navbar-expand-lg navbar-dark" >
			...
			<div id="navigation" class="collapse navbar-collapse flex-column" >
				<div class="profile-section pt-3 pt-lg-0">
				    <img class="profile-image mb-3 rounded-circle mx-auto" src="{{asset('/upload/' .$datas->image)}}" alt="image" >			
					
					<div class="bio mb-3">{{$datas->introduction}}<br><a href="about.html">Find out more about me</a></div><!--//bio-->
	    ...
	    <article class="blog-post px-3 py-5 p-md-5">
		    <div class="container">
			    <header class="blog-post-header">
				    <h2 class="title mb-2">{{$show->heading}}</h2>
			    ...
			    <div class="blog-post-body">
				    <figure class="blog-banner">
				        <a href="https://made4dev.com"><img class="img-fluid" src="{{asset('/upload/' .$show->image)}}" alt="image"></a>
				    ...
				    <h3 class="mt-5 mb-3">{{$show->heading2}}</h3>
				    <p>{{$show->content2}}</p>
				    
				    <h3 class="mt-5 mb-3">{{$show->heading3}}</h3>
				    <p>{{$show->content3}}</p>
				    <h3 class="mt-5 mb-3">{{$show->heading4}}</h3>
				    <p>{{$show->content4}}</p>

				    <!-- <div class="embed-responsive embed-responsive-16by9">
					   

					   <img src="{{asset('/upload/' .$show->image3)}}" style="width: 560px;height: 315px;">				
					</div> -->
